...
module.exports = {
  async create(req, res, next) {
    try {
      ...
      const result = await DepartmentService.create(data, req.user);
  ...
  async findAll(req, res, next) {
    try {
      const results = await DepartmentService.findAll(req.query);
      res.json(results);
    } catch (err) {
      next(err);
    }
  ...
  async update(req, res, next) {
    try {
      ...
      const result = await DepartmentService.update(req.params.id, data, req.user);
      res.json(result);
    } catch (err) {
      next(err);
    }
